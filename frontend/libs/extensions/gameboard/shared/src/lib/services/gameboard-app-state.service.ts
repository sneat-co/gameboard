...
export interface IGameboardAppState {
  collapsedGroups: string[];
  showWatched: boolean;
}

export abstract class IGameboardAppStateService extends LocalAppState<IGameboardAppState> {
...
@Injectable()
export class GameboardAppStateService extends IGameboardAppStateService {
  constructor() {
  ...
  public setShowWatched(showWatched: boolean): void {
    const appState: IGameboardAppState = {
      ...this.getAppState(),
      showWatched,
    };
    this.saveAppState(appState);
