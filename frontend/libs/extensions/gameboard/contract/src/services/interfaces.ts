...
// export abstract class IListService extends ICommuneItemService<IListDto, GameboardAppSchema, typeof ListKind> {
// 	abstract deleteList(listId: string, communeId: string): Observable<IListDto>;
// }
//
// export abstract class IListItemService extends ICommuneItemService<IListItemDto, GameboardAppSchema, typeof ListItemKind> {
// 	// noinspection JSUnusedGlobalSymbols
// 	// abstract txRemoveKinds(): string[];
//
// 	// noinspection JSUnusedGlobalSymbols
// 	abstract selectByListId(tx: IRxReadonlyTransaction<GameboardAppSchema>, listId: string, status?: ListStatus)
...
// export abstract class IGameboardService extends RxStoreService<GameboardAppSchema> {
